				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != Activity.RESULT_OK) {
							...
							Notification.Builder notificationBuilder = new Notification.Builder(mApplicationContext).setContentIntent(pendingIntent).setContentTitle("tweets").setContentText(successMsg).setSmallIcon(android.R.drawable.stat_sys_warning).setAutoCancel(true);
